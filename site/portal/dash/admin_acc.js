                ...
                try {
                    ...
                    if (!isEmpty(data)) {
                        ...
                        if (!isJsonArray(jdata)) {
                            ...
                            getbalance(value.organ, 'acc_balance', 'acc_no','1');
                            loadtransaction();
                            loadAccounts();
                        } else {
                            //Add ArrayList
...
//
            ...
            contentType: false,
            beforeSend: function () {               //tbody.html("<tr><td colspan='5' align='center'><i class = 'fa fa-spinner spin'></i> Loading</td></tr>");
                $("#acc_tab_body").html('<tr><td colspan="8" align="center"><div class="spinner-border text-primary" role="status"><span class="sr-only">Loading...</span></div></td></tr>');
            },
            complete: function (data) {
                //tbody.html("<i class = 'fa fa-spinner spin'></i> Please Wait.."+ JSON.stringify(data));
            },
                ...
                try {
                    ...
                    if (!isEmpty(data)) {
                        ...
                        if (!isJsonArray(value)) {
                            ...
                            e_data += '<td>' + value.amount + '</td>';
                            e_data += '<td>' + getAccount_type(value.type) + '</td>';
